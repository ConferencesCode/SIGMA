...
void LocalPush::save() {
    ...
    out << "c: " << c << endl;
    out << "cpu_time: " << cpu_time << endl;
    out << "mem_size " << mem_size << endl;
    auto p_size = P.size();
    auto r_size = R.size();
    out << "p_size: " << p_size << endl;
    out << "r_size: " << r_size << endl;
    out << "size(P) / n*n = " << double(p_size) / (n * n) << endl;
    out << "size(R) / n*n = " << double(r_size) / (n * n) << endl;
    out.close();
